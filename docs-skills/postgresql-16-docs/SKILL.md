...
- Treat `postgresql.org/docs/16` as the source of truth for PostgreSQL 16.
- Prefer pages under <https://www.postgresql.org/docs/16/>.
...
- For version-specific behavior, check the PostgreSQL 16 release notes before answering from older knowledge.
...
- Make any inference explicit. Good phrasing:
  - `According to PostgreSQL 16 docs, ...`
...
- Answering from memory without verifying the current PostgreSQL 16 docs
...
- Suggesting settings or syntax from a newer PostgreSQL major version without checking release notes
